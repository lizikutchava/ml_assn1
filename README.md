...
ფასების შესაფასებლად გავტესტე რამდენიმე სხვადასხვა მოდელი სხვადასხვა Feature Engineering-ებით. საუკეთესო შედეგი მივიღე Gradient Boosting Regressor-ით (RMSE = 0.13589)
